        ...
        <div>
          <div className="presentation-actions" ref={presentationActionsRef}>
            <IconContext.Provider value={{size: "20px"}}>
              ...
              <div>
                <button className="presentation-comment-btn">{tweet.liked ? <div className="presentation-comment"><FaHeart /></div> : <div className="presentation-comment"><FaRegHeart /></div>} <div>{tweet.likes}</div></button>
              </div>
